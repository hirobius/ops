 ...
 * the optimistic-update / reconcile flow and supplies the disabled flag
 * while a mutation is in flight. Currently consumerless: its last consumer,
 * the /admin/approvals inbox, was retired 2026-07-13 (ops#157).
 */
export const ApprovalCard = React.forwardRef<HTMLDivElement, ApprovalCardProps>(
  function ApprovalCard(
    { unit, onApprove, onDeny, onOpenDetail, pending = false, className },
    ref,
  ) {
