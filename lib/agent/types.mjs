 ...
 * five, no duplicates. The vendored ClientConfig schema does NOT enforce
 * uniqueness — see the drift guard in tests/agent/assemble-layout.test.ts — so
 * the constraint lives here, agent-side, rather than by forking the contract.
 */
