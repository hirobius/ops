...
import { assemble } from './generate.mjs';
...
/** Values assemble() substitutes when the lead lacks them — visible, never invented. */
const PLACEHOLDERS = { phone: '(000) 000-0000', email: 'owner@example.com' };
