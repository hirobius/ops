 ...
 * @param {{ model?: string, onUsage?: Function }} [opts]  per-call overrides for the model eval
 *   (ops#7); the production pipeline passes none and runs on MODELS.fast.
 * @returns {Promise<import('./types.mjs').Brief>}
 */
export async function enrich(lead, { model = MODELS.fast, onUsage } = {}) {
