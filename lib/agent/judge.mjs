 ...
 * @param {{ model?: string, thinking?: object, onUsage?: Function }} [opts]  per-call overrides
 *   for the model eval (ops#7); the production pipeline passes none and runs on MODELS.strong.
 * @returns {Promise<import('./types.mjs').JudgeResult>}
 */
export async function judge(lead, config, { model = MODELS.strong, thinking, onUsage } = {}) {
