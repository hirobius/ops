 ...
 * `issues` array of the `{ issues, truncated, fetched }` object returned by
 * `makeGitHubPort().listOpenIssues()` (lib/github/issues.mjs) and produces
 * rows ready for `upsertTasks` (lib/supabase/tasks.mjs). No network, no DB —
 * unit-testable as plain data-in/data-out.
 *
 ...
 *   The `issues` array from GitHubIssuePort#listOpenIssues (lib/github/issues.mjs).
