 ...
 * so it's kept next to WORK_STATE_TONE (badge tones) to prevent the two from
 * drifting apart. Deliberately coarser than the badge map: only the phases
 * that need a human's attention get a loud border.
 */
