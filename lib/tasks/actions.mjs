 ...
 *
 * `dispatch` stamps `dispatch_status: 'dispatched'` — whichever caller
 * reaches it (the /ops/tasks manual "Dispatch" button, or
 * scripts/fleet-dispatch.mjs, which already stamps 'dispatched' itself via
 * setTaskFields before calling this).
 */
