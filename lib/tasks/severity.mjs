 ...
 * in ops AND hds — change it here and the labels must be edited to match.
 */
export const SEVERITY_LADDER = Object.freeze([
  Object.freeze({
    ...
    response:
      'Surfaces on every status output until closed or explicitly accepted. Cannot be silently carried.',
  }),
  Object.freeze({
    label: 'sev2',
