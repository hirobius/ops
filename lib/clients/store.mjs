 ...
 * are business-confidential and often carry PII, so they live OUT of the public
 * hirobius/ops repo — in the private Supabase `client_records` table (migration
 * 0015). Public code and fixtures only ever use pseudonymous slugs
