# Cold outreach playbook — selling one-page sites to WA trades

A step-by-step SOP a **non-technical sales partner** can run off the pre-scored
lead list (`leads` table / prospect CSVs). Scope: WA trades — fencing & deck, tree
service, septic & excavation, pressure washing, concrete/epoxy coating. Target =
a real, reachable, owner-operated business with a **weak or absent website** and a
job ticket where one closed job pays for the site.

> **Not legal advice.** Compliance summarised from public sources (cited). When in
> doubt, keep it to hand-dialed B2B calls 8am–8pm and truthful emails.

## The one-line motion

**Phone-first + "I already built your site."** For WA trades, the **cold call is
the primary channel** (B2B calls are exempt from WA's telemarketing law, and the
...
- **Calling:** TCPA restricts *autodialers and prerecorded/AI voices* — a **live
  ...
  do-not-call request for ≥1 year. WA's law **"does not cover calls by a business
  to another business."** So: **manual dial only, no power-dialer/robo, no AI voice.**
- **Email:** CAN-SPAM is opt-out — accurate "from"/subject, a valid physical
  mailing address, and a working unsubscribe honored within 10 business days
  (fines up to ~$46k/email). **WA CEMA is the sharp edge: $500/email for any
  false or misleading subject line, no damages needed.** → **Subjects must be
  literally, verifiably true. No fake "Re:", no "as discussed," no invented urgency.**
- **DMs:** credible account (real photo/bio, some posts), engage first, cap
  **20–30 personalized DMs/day**, rotate 5–7 variants.

## 2. The "spec-site-first" offer

Leading with a tangible artifact beats a plain pitch. Our unfair advantage: we can
...
2. For **low-`buildScore`** leads, use a cheaper **60-second Loom teardown** of their
   Google Business Profile / Facebook page instead of a full build.
3. **First touch = call.** "I built you a quick sample site — can I text/email the
   link?" Get a soft yes, then send it (now consented → texting is fine).
4. The link does the selling: live, mobile-first, their real info, one clear CTA.
...
## 4. Funnel math (be honest with the partner)

- **Email:** healthy-list reply **1–3%**, top-quartile 8–25% with strong targeting.
- **Cold call (web design → local biz):** ~**2–5% of dials → paying client**; ~50
  targeted calls/day for a month ≈ **2–3 projects**. It takes **6–10 attempts** to
  reach a given owner; **multichannel (call + email) lifts conversion ~70%**.
- **Worked target — 4 sites/month:** ~150–200 quality dials/month = **~30–50
  dials/day, 4 days/week** on top-scored leads. Follow-ups (touches 2–4) win most deals.
- **Where partners waste time:** chasing low-score leads instead of the top of the
  list; over-building spec sites for cold prospects (use the teardown); writing a
  novel per email; **not following up** (the #1 leak); fake "Re:" subjects (WA legal risk).

## 5. Objection handling (agree → reframe, never argue)

- **"I get all my work by word of mouth."** → "That's exactly why this works — a
  referral's first move is to Google you, and right now they find nothing. This makes
  sure every referral reaches you. It adds to word-of-mouth."
- **"I have a Facebook page."** → "Good one, too — but it doesn't show up on Google
  for '[fence company near me]', and you can't control the look. Pulled your reviews
  and photos from it, actually — want to see?"
- **"Too expensive."** → "What's one [job] worth to you? This pays for itself with a
  single extra job, then works all year. One-time, not a big commitment."
- **"No time."** → "That's the point — it's already built. I need ~10 minutes of you
  confirming your info's right; I handle the rest."
- **"Send me info / let me think."** → "I can do better than a brochure — I already
  built the real site with your business on it. Let me text the link; look tonight,
  and if it's not for you just tell me."
- **"I'll do it myself / my nephew can."** → "Doable — question is whether it gets
  done. Mine's finished today and built for getting you jobs. Want to see it first?"

## 6. Daily SOP + tooling

**Daily loop (~3–4 focused hours):** pull today's slice (top scores first: high
reviews + rating + photos + no/weak site) → filter (skip real-site, no-phone,
opt-outs; confirm WA + target category) → personalize one true detail (30s each) →
**dial 30–50 by hand** 8am–8pm + send the day's emails + ≤20–30 DMs; send spec-site
links to warm/soft-yes → **track every outcome immediately** → **clear due
follow-ups before starting new leads** → warm handoff to the demo/close call.
...
**Learn what converts:** tag every lead with **niche** + **message variant** and log
the final outcome. Weekly, review reply/close rate **by niche** and **by variant**;
double down on winners, kill losers. This tells us which trades to scrape more of
next month — closing the loop between the pipeline and the sales floor.

## 7. Partner incentive / handoff
...
- **WA CEMA subject-line liability is real and litigated** — sloppy email subjects
  are the single biggest legal risk here, another reason the phone-first,
...
- [Consumer Action — small-business TCPA guide](https://www.consumer-action.org/modules/articles/TCPA_business)
- Reply/call benchmarks: [Instantly](https://instantly.ai/blog/cold-email-reply-rate-benchmarks/) · [Focus Digital — cold-call conversion](https://focus-digital.co/average-cold-call-conversion-rate/) · [Close.com — funnel metrics](https://close.com/blog/cold-calling-conversion-funnel-analytics)
- Offer/video: [Weezly — Loom cold email](https://weezly.com/blog/boost-cold-email-replies-with-loom-videos/) · [getmapleads — Maps outreach + objections](https://getmapleads.io/blog/cold-outreach-strategy-web-agencies)
