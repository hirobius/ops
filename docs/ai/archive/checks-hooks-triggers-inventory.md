...
(commit `20f351e`) covered the _dormant_ check:\* landscape; this document
...
_Grounded against: `package.json` (scripts section), `.husky/pre-commit`, `.husky/pre-push`,
`.github/workflows/_.yml`, `scripts/`directory listing, commit`20f351e` (prior dormant audit).\*
