...
| `docs/prospecting/`, `scripts/lib/query-presets.mjs`               | ralph-dispatch (`session_01ALKdCTLRLXykNrm4okMwfh`) | 2026-09-16 | **active — vertical tiers + home market (Spokane/North Idaho). Docs + preset data + tests only; no scoring change, WA_METROS untouched.**                                                                                     |
