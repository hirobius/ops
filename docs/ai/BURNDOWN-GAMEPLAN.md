...
| #        | Decision                                                       | My rec                                                                                                                                                                                                                                   |
| -------- | -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **#238** | Make auto-merge the hard default (drop per-issue `ralph-auto`) | **Decomposed — see the 2026-09-14 decision comment on ops#238, not this row.** Boxes 2 and 3 are already done; the remainder is the engine-side path check (Ralph#25) and only then the flip (ops#402). That order is a safety property. |
