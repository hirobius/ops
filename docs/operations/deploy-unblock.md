...
> repo ships **GitHub Packages distribution** — `origin/main` tip `23cfdae` _"Fix
> standalone extraction: build, nav, SSR + GitHub Packages distribution (#1)"_, PR #1
...
### Option 1 — Publish the package _(recommended; fixes CI, Vercel, fresh clones)_
...
### Option 2 — Vendor the built package _(fastest path to a preview today)_
...
### Option 3 — Monorepo / submodule _(heaviest)_
