    ...
    Icon: {
      matrix: (
        <Surface padding="component">
          <TextLockup size="section" title="Icon Registry" titleAs="h3" />
          <IconGallery />
        </Surface>
      ),
    },
      ...
      matrix: (
        <VariantStrip
          ...
          variants={[
            ...
            {
              label: 'With sub',
              node: <Stat label="Retainer" value="$1,500" sub="agreed-verbal" />,
            },
          ]}
        />
      ),
          ...
          variants={[
            {
              ...
              node: (
                <StatusListItem
                  tone="neutral"
                  title="Draft retainer scope"
                  notes={['Owner: Adrian']}
                />
              ),
            },
            { label: 'Info', node: <StatusListItem tone="info" title="Evaluating CRM API" /> },
            {
              label: 'Warning',
              node: (
                <StatusListItem
            ...
            {
              label: 'Success',
              node: <StatusListItem tone="success" title="Brand audit delivered" />,
            },
            {
              label: 'Danger',
              node: (
      ...
      matrix: (
        <VariantStrip
          ...
          variants={[
            {
              label: 'Neutral',
              node: <StatusTile title="Brand audit delivered" notes={['Owner: Adrian']} />,
            },
            {
              label: 'With trailing',
              node: (
      ...
      matrix: (
        <VariantStrip
          ...
          variants={[
            {
              label: 'Default',
              node: <PhaseHeader name="Phase 1 — Foundation" done={3} total={5} />,
            },
            {
              label: 'Success',
              node: (
      ...
      matrix: (
        <VariantStrip
          ...
          variants={[
            {
              label: 'Local',
              node: <AgentTag assignee="hermes3" modelTier="open-local" costCeiling={0} />,
            },
            {
              label: 'Frontier',
              node: (
